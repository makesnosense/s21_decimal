...
START_TEST(test_floor_fail_incorrect_decimal) {
  // 1.2345678910111213141516123235
  s21_decimal input_decimal_1 = {
      {0xCCA47C63, 0xC1EEF784, 0x27E41B32, 0b00010000000111000000000100000000}};

  s21_decimal s21_result_decimal;
  CalculationResult s21_return_code =
      s21_floor(input_decimal_1, &s21_result_decimal);

  ck_assert_int_eq(s21_return_code, CALCULATION_ERROR);
}
END_TEST

START_TEST(test_floor_gen_0) {
  // 1.2345678910111213141516123235
  s21_decimal input_decimal_1 = {
      {0xCCA47C63, 0xC1EEF784, 0x27E41B32, 0b00000000000111000000000000000000}};
  // 1
...
START_TEST(test_floor_gen_2) {
  // -5.500
  s21_decimal input_decimal_1 = {
      {0x0000157C, 0x00000000, 0x00000000, 0b10000000000000110000000000000000}};
  // -6
  s21_decimal expected_result = {
      {0x00000006, 0x00000000, 0x00000000, 0b10000000000000000000000000000000}};
...
START_TEST(test_floor_gen_6) {
  // -792281625142643375935439503.9
  s21_decimal input_decimal_1 = {
      {0x9999999F, 0x99999999, 0x19999999, 0b10000000000000010000000000000000}};
  // -792281625142643375935439504
  s21_decimal expected_result = {
      {0x28F5C290, 0xF5C28F5C, 0x028F5C28, 0b10000000000000000000000000000000}};
...
START_TEST(test_floor_gen_9) {
  // -7922816251426433759354395033.5
  s21_decimal input_decimal_1 = {
      {0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0b10000000000000010000000000000000}};
  // -7922816251426433759354395034
  s21_decimal expected_result = {
      {0x9999999A, 0x99999999, 0x19999999, 0b10000000000000000000000000000000}};
...
START_TEST(test_floor_gen_12) {
  // -2934834509834059832.45
  s21_decimal input_decimal_1 = {
      {0x39AE160D, 0xE8E6ABBA, 0x0000000F, 0b10000000000000100000000000000000}};
  // -2934834509834059833
  s21_decimal expected_result = {
      {0xF1378039, 0x28BAA06F, 0x00000000, 0b10000000000000000000000000000000}};
...
START_TEST(test_floor_gen_13) {
  // -42.353455
  s21_decimal input_decimal_1 = {
      {0x0286432F, 0x00000000, 0x00000000, 0b10000000000001100000000000000000}};
  // -43
  s21_decimal expected_result = {
      {0x0000002B, 0x00000000, 0x00000000, 0b10000000000000000000000000000000}};
...
START_TEST(test_floor_gen_14) {
  // -11353455324534534597889.779
  s21_decimal input_decimal_1 = {
      {0xFC69CEF3, 0x0BE11FCC, 0x00096430, 0b10000000000000110000000000000000}};
  // -11353455324534534597890
  s21_decimal expected_result = {
      {0xD4386D02, 0x78D8087A, 0x00000267, 0b10000000000000000000000000000000}};
...
Suite* make_floor_suite() {
  Suite* floor_suite = suite_create("floor");
  TCase* tc_core;

  tc_core = tcase_create("Core");

  tcase_add_test(tc_core, test_floor_null);
  tcase_add_test(tc_core, test_floor_fail_incorrect_decimal);

  tcase_add_test(tc_core, test_floor_gen_0);
  tcase_add_test(tc_core, test_floor_gen_1);
  tcase_add_test(tc_core, test_floor_gen_2);
  tcase_add_test(tc_core, test_floor_gen_3);
  tcase_add_test(tc_core, test_floor_gen_4);
  tcase_add_test(tc_core, test_floor_gen_5);
  tcase_add_test(tc_core, test_floor_gen_6);
  tcase_add_test(tc_core, test_floor_gen_7);
  tcase_add_test(tc_core, test_floor_gen_8);
  tcase_add_test(tc_core, test_floor_gen_9);
  tcase_add_test(tc_core, test_floor_gen_10);
  tcase_add_test(tc_core, test_floor_gen_11);
  tcase_add_test(tc_core, test_floor_gen_12);
  tcase_add_test(tc_core, test_floor_gen_13);
  tcase_add_test(tc_core, test_floor_gen_14);
  tcase_add_test(tc_core, test_floor_gen_15);
  tcase_add_test(tc_core, test_floor_gen_16);
  tcase_add_test(tc_core, test_floor_gen_17);
  tcase_add_test(tc_core, test_floor_gen_18);
  tcase_add_test(tc_core, test_floor_gen_19);
  tcase_add_test(tc_core, test_floor_gen_20);
  tcase_add_test(tc_core, test_floor_gen_21);
  tcase_add_test(tc_core, test_floor_gen_22);

  suite_add_tcase(floor_suite, tc_core);
