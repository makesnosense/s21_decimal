...
START_TEST(test_round_gen_1) {
  // 5.50
  s21_decimal input_decimal_1 = {
      {0x00000226, 0x00000000, 0x00000000, 0b00000000000000100000000000000000}};
  // 6
  s21_decimal expected_result = {
      {0x00000006, 0x00000000, 0x00000000, 0b00000000000000000000000000000000}};
...
START_TEST(test_round_gen_4) {
  ...
  s21_decimal expected_result = {
      {0x28F5C290, 0xF5C28F5C, 0x028F5C28, 0b00000000000000000000000000000000}};
...
START_TEST(test_round_gen_8) {
  // 7.9228162514264337593543950335
  s21_decimal input_decimal_1 = {
      {0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0b00000000000111000000000000000000}};
  // 8
  s21_decimal expected_result = {
      {0x00000008, 0x00000000, 0x00000000, 0b00000000000000000000000000000000}};
...
START_TEST(test_round_gen_10) {
  // 7922816251426433.7593543950335
  s21_decimal input_decimal_1 = {
      {0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0b00000000000011010000000000000000}};
  // 7922816251426434
  s21_decimal expected_result = {
      {0x68497682, 0x001C25C2, 0x00000000, 0b00000000000000000000000000000000}};
...
Suite* make_round_suite() {
  Suite* round_suite = suite_create("round");
  TCase* tc_core;
  ...
  tcase_add_test(tc_core, test_round_gen_3);
  tcase_add_test(tc_core, test_round_gen_4);
  tcase_add_test(tc_core, test_round_gen_5);
  tcase_add_test(tc_core, test_round_gen_6);
  tcase_add_test(tc_core, test_round_gen_7);
  tcase_add_test(tc_core, test_round_gen_8);
  tcase_add_test(tc_core, test_round_gen_9);
  tcase_add_test(tc_core, test_round_gen_10);
  tcase_add_test(tc_core, test_round_gen_11);
  tcase_add_test(tc_core, test_round_gen_12);
  tcase_add_test(tc_core, test_round_gen_13);
  tcase_add_test(tc_core, test_round_gen_14);
  tcase_add_test(tc_core, test_round_gen_15);
  tcase_add_test(tc_core, test_round_gen_16);
  tcase_add_test(tc_core, test_round_gen_17);
  tcase_add_test(tc_core, test_round_gen_18);
  tcase_add_test(tc_core, test_round_gen_19);
  tcase_add_test(tc_core, test_round_gen_20);
  tcase_add_test(tc_core, test_round_gen_21);
  tcase_add_test(tc_core, test_round_gen_22);

  suite_add_tcase(round_suite, tc_core);
